    ...
    function (e, t, n) {
        ...
        ;(this.handleImageLoad = function (e) {
          ...
          (this.handleYoutubeLoad = function () {
            ...
            i.maxYoutubeDimensions &&
              ((e = i.maxYoutubeDimensions.width), (t = i.maxYoutubeDimensions.height)),
              s.runActions(e, t)
          }),
      ...
      function N(e, t) {
        ...
        ;(i[t] = document.createElement('iframe')),
          ...
          (i[t].src = 'https://www.youtube.com/embed/'.concat(
            c[t].match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|\&v=)([^#\&\?]*).*/)[2],
            '?enablejsapi=1'
          )),
          ...
          (function (e, t) {
            ...
            ;(n.enterFullscreen = function () {
              ...
              (s.onclick = function () {
                ...
                //document.querySelector('body').classList.toggle('.switched-on ')
              })
          })(e, n),
          (function (e, t) {
            var n = R(t, 'Close')
        ...
        ;(n = (t = e).core.classFacade),
          ...
          (function (e) {
            ...
            t.closeLightbox = function () {
              console.log('close')
              document.querySelector('body').scrollTop = offsetY
              //document.querySelector('body').classList.toggle('switched-on')
      ...
      function te(e) {
        ...
        ;(n.isInitialized = !0),
          ...
          (function (e) {
            for (
              var t = e.props.sources, n = e.resolve, o = n(w), r = n(M), i = n(H, [o, r]), s = 0;
              s < t.length;
              s++
            )
